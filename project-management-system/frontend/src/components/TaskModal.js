                        ...
                        >
                            <Dialog.Panel className="rounded-md bg-white max-w-[85%] w-[85%] h-[85%] overflow-y-hidden">
                                ...
                                <Dialog.Title as='div' className={'bg-white shadow px-6 py-4 rounded-t-md sticky top-0'}>
                                    <h1>Task details</h1>
                                    <button onClick={() => setIsOpen(false)} className='absolute right-6 top-4 text-green-500 hover:bg-green-100 rounded focus:outline-none focus:ring focus:ring-offset-1 focus:ring-green-500/30 '>
